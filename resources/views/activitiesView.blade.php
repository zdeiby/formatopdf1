...
<br>
    <div class="container">
    <img src="/informeactividades/public/imagenes/headers.png" alt="" width="100%">
    <hr><br>
       <button style="background:#f0f0f0" class="btn btn-outline-secondary btn-sm"  id="btn-formato-pdf">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
  ...
  <script>
    $('#btn-formato-pdf').click(function(){
        ...
        window.open(`http://unidadfamiliamedellin.com.co/informeactividades/public/guardarpdf/${url}`, '_blank','toolbar=no, location=no');
    });
